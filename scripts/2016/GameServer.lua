...
local function reportPlayerEvent(userId, t)
	...
	local ok, msg = pcall(function()
		...
		-- print("sending",msg)
		game:HttpPost("http://www.moonic.wtf/gs/players/report", msg, false, "application/json");
	end)
...
local function shutdown()
	...
	pcall(function()
		game:HttpPost("http://www.moonic.wtf/gs/shutdown", http:JSONEncode({
			["authorization"] = "",
			["serverId"] = game.JobId,
			["placeId"] = placeId,
		}), false, "application/json");
